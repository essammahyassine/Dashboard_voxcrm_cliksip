...
<?php
    ...
    if (isset($_POST['save'])) {
        ...
        $queryrec = "SELECT c.RefProspect, c.NumAppel1,    c.NUM_CLIENT,   c.NUM_CLIENT2, c.ClientID, c.ClientID2 , c.CIVILITE, c.BA_NOM as NOM,  c.BA_PRENOM as PRENOM,  c.ADR_ETAGE,    c.ADR_BATIMENT, c.ADR_RUE,  c.ADR_4,    c.ADR_CP,   c.ADR_COMMUNE,  c.NAIS_EMP, c.AGE_EMP,  c.NAIS_CO_EMP,  c.AGE_CO_EMP,   c.CIVILITE_COT, c.NOM_COT,  c.PRENOM_COT,   c.NUM_PLAN, c.CSP,  c.SITUATION_FAMILIALE,  c.SITUATION_LOCATIVE,   c.TOP_CIBLE,    c.COTISATION,   c.COTISATION_2, c.CAPITAL,  c.PRIME_MOIS,   c.PRIME_MOIS_2, c.PRIME_JOUR,   c.PRIME_JOUR_2, c.COUVERTURE_1, c.COUVERTURE_2, c.COUVERTURE_5, c.DEST, c.Refappel, u.name as HOTESSE,    DATE_FORMAT( o.agent_start,  '%d%m%Y' ) AS DateAppel,   DATE_FORMAT( o.agent_start,  '%H%i%s' ) AS HeureAppel,  s.RefQualif,    s.RefCatg,  c.Newrib,   c.BIC,  c.RecordFileName,   c.PREUVE_SONORE_OUT,    s.Conclusion,   s.MotifRefus,   s.Lib_EI, c.MENS_VAL,c.DETTE,c.COUVERTURE_3,c.CAPITAL,o.monitor_filename as Link,o.note,c.phone_1 as TEL,c.COMMENTAIRE as comi
  ...
  <?php
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Bazile Telecome</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <?php
                    ...
                    // 
                               $recname = '979_CALL1_'.$rowcont['DateAppel'].'_'.$rowcont['TEL'].'_'.$rowcont['NOM']
                                .$rowcont['PRENOM'].'.wav';
                    ?>
...
<script>
    ...
    <?php
            ...
            echo '<script>window.location="https://192.168.1.4/DashKGL/?id=29";</script>';
