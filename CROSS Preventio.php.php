...
<?php
        ...
        <div class="content mt-3" style="padding-top: 250px">
            ...
            <div class="">
                    <div style="text-align:center; background-color:#3399CC; padding:5px;color:white"><H1><CENTER><B>Preventio - Enregistrement</B></CENTER></H1></div>
                            ...
                            <div style="text-align:left;margin-left:50px"><strong style="color:green"> <?=$rowcont['CIVILITE'] .' '. $rowcont['NOM']; ?> </strong> l’enregistrement vient de débuter, je suis Sophie Berthier / Stéphane Caron, responsable Prévoyance de COFIDIS, société de courtage d&#39;assurance qui vous propose le contrat d&#39;assurance PREVENTIO assuré auprès de SERENIS ASSURANCES. </div>
                            </br>


                            <div style="text-align:left;margin-left:50px">Très bien <strong style="color:green"><?=$rowcont['CIVILITE'] .' '. $rowcont['NOM']; ?></strong>, afin d&#39;éviter toute erreur administrative dans le traitement de votre adhésion, êtes-vous toujours d’accord pour qu"il soit procédé à l’enregistrement de la présente conversation téléphonique ? </div>
                            </br>
                            ...
                            Les informations collectées lors de cet enregistrement seront notamment traitées par <strong style="color:green">COFIDIS</strong> et SERENIS ASSURANCES aux fins d&#39;exécution du contrat et d&#39;exploitation commerciale. Bien entendu, vous bénéficiez d&#39;un droit d&#39;accès, de rectification et d&#39;opposition au traitement de vos données personnelles auprès de <strong style="color:green">COFIDIS</strong> par courrier simple.
                            </br>
 ...
 <div class="modal  fade" id="myModal" role="dialog">
    ...
    <!-- __________________________________________________________________________________________________________________________________________________________________________________-->
                            ...
                            <div style="text-align:left;margin-left:50px"><strong style="color:green"><?=$rowcont['CIVILITE'] .' '. $rowcont['NOM']; ?></strong>, <b style="color:red">nous vous informons que compte-tenu de votre situation personnelle</b>, vous bénéficiez de la garantie Décès accidentel   <b>[    ainsi que la garantie Perte Totale et Irréversible d&#39;Autonomie] suite à un accident dès lors que vous : </b>
                            <ul>
                            <li> êtes âgé(e) de moins de 70 ans,</li>
                            <li> avez votre résidence principale et fiscale en France métropolitaine,</li>
                            </ul>
                            Vous nous confirmez donc votre intérêt à une assurance de prévoyance individuelle qui vous couvrirait en cas de décès accidentel <b>[ et de Perte totale et irréversible d&#39;autonomie  ]</b> consécutive à un accident ?  </div>
                            </br>
                            ...
                            <div style="text-align:left;margin-left:50px">Parfait, compte tenu de l&#39;ensemble des informations que vous nous avez fournies, le contrat PREVENTIO est conseillé. 
                            PREVENTIO répond à votre besoin en ce sens qu"il prévoit de vous assurer dés la fin de cet enregistrement, en cas de décès accidentel <b>[   et en cas de Perte Totale et Irréversible d&#39;Autonomie consécutive à un accident   ]</b> pour <strong style="color:brown"> <?=$rowcont['COTISATION']?> </strong> euros par mois pour un montant de <strong style="color:brown"><?=$rowcont['PRIME_MOIS']?> </strong> euros dont :
                            <ul>
                            ...
                            <li> vous bénéficiez en plus d&#39;une assistance personnalisée </li>
                            </ul>
                            Vous trouverez la définition complète de ces garanties ainsi que les cas de cessation de ces garanties dans la notice d&#39;information. Il y a quelques exclusions comme par exemple la maladie, l&#39;usage de stupéfiants, la pratique de sport à titre professionnel ou d&#39;accident survenu sous l&#39;emprise d&#39;un état alcoolique: je vous invite à les consulter également dans la Notice d&#39;information de l&#39;assurance que je vais vous envoyer. </div>
                            </br>
                            <div style="text-align:left;margin-left:50px">En cas de décès accidentel, les bénéficiaires sont votre conjoint (marié non séparé de corps ou votre partenaire lié par un PACS ou votre concubin notoire), à défaut, par parts égales vos enfants nés ou à naître, vivants ou représentés, à défaut, par parts égales, vos héritiers. 
                            Vous confirmez ? 
                            </div>
                            </br>
                            <div style="text-align:center"><strong style="color:green">Réponse client: OUI</strong></div>
                            </br>
                            <div style="text-align:left;margin-left:50px;color:blue"><i>J&#39;ai encore quelques questions à vous poser et vous serez totalement tranquille.</i></div>
                            </br>
                            <div style="text-align:left;margin-left:50px">En l’absence de bénéficiaire acceptant, vous pouvez bien évidemment modifier à tout moment la désignation du bénéficiaire par courrier avec lettre recommandée envoyée à l&#39;assureur dont vous trouverez les coordonnées dans la notice d&#39;information.
                            ...
                            Vous avez la possibilité de renoncer à cette adhésion dans les 14 jours qui suivent la reception des conditions generales selon les modalités détaillées dans la Notice d&#39;information.  
                            </div>
                            </br>
                            ...
                            <div style="text-align:left;margin-left:50px">Votre accord vaut mandat de prélèvement. La référence unique de mandat vous sera confirmée lors de l&#39;envoi du certificat de garantie. <br/>
                            ...
                            <div style="text-align:left;margin-left:50px">Suite à notre conversation vous recevrez le certificat de garantie et la notice d&#39;information. En plus, nous avons le plaisir de vous offrir le premier mois de cotisation. 
                            Souhaitez-vous en savoir plus ou bien les informations déjà fournies vous semblent suffisantes ?</div> 
                            </br>


                            <div style="text-align:left;margin-left:50px"><strong style="color:green"><?=$rowcont['CIVILITE'] .' '. $rowcont['NOM']; ?></strong>, Je vous remercie du temps que vous m&#39;avez consacré, je vous souhaite une excellente journée de la part de COFIDIS.</div>
                        <?php
                            }
