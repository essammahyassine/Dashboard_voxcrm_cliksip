  ...
  <?php
    ...
    <div id="right-panel" class="right-panel">
        ...
        <?php
            ...
            <div class="col-xl-12">
                    <div style="text-align:center; background-color:#999900;color:white;padding:5px"><H2><CENTER>Indemni+ Or - Enregistrement</CENTER></H2></div>
                            </br>
...
<script>
    ...
    <?php
            ...
            echo '<script>window.location="https://192.168.1.4/DashKGL/?id=20";</script>';
