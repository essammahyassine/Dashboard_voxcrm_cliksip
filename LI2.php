                ...
                <div class="" style="padding-bottom: 20px">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card-header">
                            <strong class="card-title">Statistiques Autres Camapagnes ( <?=$dt?> )</strong>
                        </div>
                        <div class="card-body">
...
<?php
        ...
        $QueryCamp = "SELECT distinct camp.name as campagne,camp.id as ID FROM 
                    ...
                    where DATE_FORMAT(o.agent_start , '%d/%m/%y')='".$dt."' and camp.comment='Autre' and camp.id=s.campaign_id";
