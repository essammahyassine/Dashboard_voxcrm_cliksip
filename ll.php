                            ...
                            <table class="table table-striped" id="HO">
                              ...
                              <tbody id="cc">
                                <script>
                                    ( function ( $ ) {
                                            $.ajax({
                                                url: 'https://192.168.1.4/DashboradKGL/JSS.php',
                                                method: 'GET',
                                                success: function(data) {
                                                    console.log(data);

                                               
                                                while( var i < data.length-2)
                                                {

                                                      
                                                    document.getElementById('cc').innerHTML +=
                                                        '<tr><td>'+parseInt(data[i].HeureAppel.substring(0,2) - data[i].HeureAppel.substring(0,2))+'</td><td>'+data[i].HeureAppel+'</td><td>'+data[i].HOTESSE+'</td><td>'+
                                                        data[i].Telephone+'</td></tr>';
