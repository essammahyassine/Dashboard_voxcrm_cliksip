<?php
            ...
            $sql_stat = 'SELECT HOUR( o.agent_start ) as Heure,count(o.status) as Accord
            ...
            AND camp.id = s.campaign_id and DATE_FORMAT( o.agent_start, "%d/%m/%y" )="'.$dt.'" and s.positive=1 and o.cid="'.$idcamp.'" and o.agent_id="'.$idag.'" group by HOUR( o.agent_start )';
