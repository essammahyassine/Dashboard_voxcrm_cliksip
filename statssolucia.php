...
<?php
    ...
    else
    {
        ...
        $Q1 = "SELECT num,text FROM `campaigns_status` WHERE `campaign_id`='30' and text!=''";
        $Q2= "SELECT num,text FROM `campaigns_status` WHERE `campaign_id`='30' and text!=''";
        $Q3 = "SELECT num,text FROM `campaigns_status` WHERE `campaign_id`='30'  and text!=''";
        $Q4 = "SELECT num,text FROM `campaigns_status` WHERE `campaign_id`='30'  and text!=''";
