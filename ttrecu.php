<?php
            ...
            $sql_stat = 'SELECT HOUR( o.agent_start ) as Heure,count(o.status) as Appel
            ...
            AND camp.id = s.campaign_id and DATE_FORMAT( o.agent_start, "%d/%m/%y" )="'.$dt.'" and s.REFQUALIF in ("1","110","111","0","6") and o.cid="'.$idcamp.'"
